...
import { ForbiddenError, EventType, WriteIntent, WriteDecisionReason, WritePermitStatus, evaluateWriteDecision, ResourceRef, WriteDecision, WritePermit, WriteResourceHash } from "syncpoint-kernel";
import {
  safeResolve,
  readResourceHash,
  resolveBaseHashes,
...
// File I/O utilities (safeResolve, readResourceHash, etc.) extracted to file-io.ts
