...
import { OperationStatus, type Operation } from "./operation.js";
import { ResourceClaimMode, ResourceClaimStatus, type ResourceClaim, type ResourceRef } from "./resource.js";
import { SyncGateReason, SyncGateStatus, type SyncGate } from "./sync-gate.js";
import { evaluateWriteDecision, WriteDecisionReason, WriteIntent } from "./write-permit.js";
...
function gate(overrides?: Partial<SyncGate>): SyncGate {
  return {
    ...
    relatedResourcesJson: JSON.stringify([resource("src/auth.ts")]),
    relatedCheckpointId: "",
    relatedClaimIds: "",
